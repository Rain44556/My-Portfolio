...
const Contact = () => {
    return (
      ...
      <div className="container mx-auto text-center">
        ...
        <p className="text-[#D1F26D] mb-8">
          Feel free to reach out to me for any opportunities or queries. I'm always excited to connect and collaborate!
        </p>
      </div>
  ...
  <div className="grid lg:grid-cols-2 gap-10">
    ...
    <Link
          ...
          >
          <span> <MdAttachEmail  size={24}/></span>
    ...
    <div className="card w-full max-w-lg shrink-0 shadow-2xl py-10">
      ...
      <div className="form-control">
          <input type="text" placeholder="Enter Full Name" className="input bg-gray-800 px-6 py-6 input-bordered" required />
        </div>
        <div className="form-control">
